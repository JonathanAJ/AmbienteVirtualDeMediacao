				...
				<div class="ui row menu-perfil">
					<div class="column">
						<img class="ui medium image centered"
							 src="img/person.jpg">
						<div class="ui huge star rating mg-tp-5"
							 data-rating="5"
				...
				<div class="ui row menu-opcoes">
					<div class="column">
						<div class="ui teal tiny vertical buttons">
						  <button class="ui button"><i class='icon plus'></i> Novo Post</button>
						  <button class="ui button"><i class='icon book'></i> Meus Posts</button>
						  <button class="ui button"><i class='icon sitemap'></i> Núcleo</button>
						  <button class="ui button"><i class='icon empty star'></i> Favoritos</button>
						</div>
						<div class="ui divider"></div>
						<div class="ui teal tiny vertical buttons">
						  <button class="ui button"><i class='icon comments'></i> Mensagens</button>
						  <button class="ui button"><i class='icon trash'></i> Excluídos</button>
						  <button class="ui button"><i class='icon users'></i> Amigos</button>
						  <button class="ui button"><i class='icon cubes'></i> Geomapa</button>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="ui grid">
				<div class="row">
					<div class="sixteen wide column mg-tp-25">
						...
						<p class="mg-tp-15-menos">Mediadora, Fortaleza-CE <i class='icon user teal'></i></p>
						<div class="ui form mg-tp-30">
							<div class="ui action input fluid">
							  <input type="text" name="busca" placeholder="Pesquise aqui os posts do sistema">
						...
						<div class="ui items">
						  ...
						  <div class="item">
						    ...
						    <div class="middle aligned content">
						      ...
						      <div class="description color-white">
						        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos, animi, voluptatum.</p>
								<span class="ui left floated">
								<i class="comment icon"></i>
								9 Comentários
								</span>
