 ...
 * from our JCG partner Ricardo Zuasti at the Ricardo Zuasti’s blog blog.
 * 
 * e
 * 
 * Madoke/XSSRequestWrapper.java forked from ulinkwo/XSSRequestWrapper.java
 */

public class XSSController extends HttpServletRequestWrapper {

	private Map<String, String[]> sanitizedQueryString;

    public XSSController(HttpServletRequest servletRequest) {
